        ...
        <div className="container">
            <div className="row mt-3">
                <div className="col-lg-12">
                    <h2 className='text-center text-primary fontweight'><i className='fa fa-hospital-o'></i> Hospital Dashboard</h2>
                    <div className="row mt-4">
                        ...
                        <div className="col-lg-2 my-3">
                        <Link className='decoration' to="/patients">
