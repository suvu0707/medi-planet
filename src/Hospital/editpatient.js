...
const Editpatient = () =>{
    ...
    const getAllDoctors = () =>{
        ...
        fetch("https://www.medicalplanet.in/webapi/Doctor/getall", requestOptions)
        .then(response => response.json())
        .then(data =>{              
                // console.log(data);
                updateAllDoc(data);            
    ...
    return(
        <div className="container">
            <div className="row mt-3">
                <h1 className="text-info text-center">Patient Details : {pname}</h1>
                ...
                <div className="col-lg-4">
                    <div className="mt-1">
                        ...
                        <select className="form-select" onChange={obj=>getAmount(obj.target.value)}>
                            <option value={pdocid}>{pdoctor}</option>
                            {
                                alldoc.map((ddata, index)=>{
                                    return(
